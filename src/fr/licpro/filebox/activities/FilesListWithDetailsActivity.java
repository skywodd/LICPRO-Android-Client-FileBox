...
/**
 * Master/details activity for large screen.
 * 
 * @author skywodd
 */
public class FilesListWithDetailsActivity extends AbstractBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.i(LOGCAT_TAG, "FilesListWithDetailsActivity::onCreate()");

		/* Set content view */
		setContentView(R.layout.activity_files_list_with_details);
	}
