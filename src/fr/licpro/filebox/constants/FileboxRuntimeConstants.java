...
/**
 * Constant runtime variables of the application.
 * 
 * @author Skywodd
 */
public interface FileboxRuntimeConstants {
	 ...
	 */
	public static final String API_URL = ""; // FIXME DO NOT INCLUDE IN COMMIT
